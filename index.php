...
<body>
    ...
    <div class="container" style="margin-top: 30px;">
        <div class="row" style="margin-bottom: 20px;">
            ...
            <div class="col-sm-2"><a style="display: flex;flex-direction: column;" href=""><span><img style="border-radius: 5px;" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQSGmki8uieMMY6oHOEuP2Q6uMNRgCGC_Xzg&usqp=CAU" alt=""></span></a><span style="padding-left: 20px;">Phụ kiện</span></div>
            <div class="col-sm-2"><a style="display: flex;flex-direction: column;" href=""><span><img style="border-radius: 5px;" src="http://cdn.onlinewebfonts.com/svg/img_464186.png" alt=""></span></a><span style="padding-left: 15px;">Thương hiệu</span></div>
            <div class="col-sm-2"><a style="display: flex;flex-direction: column;" href=""><span><img style="border-radius: 5px;" src="https://png.pngtree.com/element_our/png_detail/20181213/awardhonormedalrankreputationribbon-glyph-icon--vector-png_267720.jpg" alt=""></span></a><span style="padding-left: 20x;">Thời thượng </span></div>
        </div>
        <!-- <div class="row">
